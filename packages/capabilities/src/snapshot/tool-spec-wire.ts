import type { ToolCapabilityCanonicalPayload } from "../hashing/canonical-payloads.js";
 ...
 */
export function toolCapabilityPayloadFromWire(wire: ToolSpecWire): ToolCapabilityCanonicalPayload {
...
/**
 * SHA-256 hex of {@link toolCapabilityPayloadFromWire} (same digest as {@link hashToolSpecStatic} for an equivalent live {@link ToolSpec}).
 */
export async function hashToolSpecWire(wire: ToolSpecWire): Promise<string> {
  return hashPlainObject(toolCapabilityPayloadFromWire(wire));
}
